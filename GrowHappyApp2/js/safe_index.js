function menu_01()
{
     ...
     btn1.style.color="#0fb8f3";
     var btn2 = document.getElementById('menu2');  
     btn2.style.backgroundColor="#0fb8f3"; 
     btn2.style.color="white";
     var btn3 = document.getElementById('menu3');  
     btn3.style.backgroundColor="#0fb8f3";
...
function menu_02()
{
    ...
    var  btn2= document.getElementById('menu2');  
     ...
     btn2.style.color="#0fb8f3";
     var btn1 = document.getElementById('menu1');  
     btn1.style.backgroundColor="#0fb8f3"; 
