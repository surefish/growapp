...
function goNextPage(i){
	 plus.storage.setItem("wdrybfuid", i);
  
	showFact('photo_detail_ryb.html', '首页', '', 'photo_detail_ryb','');
}
...
/**
		...
		function createUpload(path, name) {
			...
			var task = plus.uploader.createUpload(ip + "newbegin/index/uploadImg?mypoType=" + "ryb", {
					method: "POST",
					blocksize: 204800,
					priority: 100
				},
